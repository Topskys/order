 ...
 * @LastEditTime: 2023-04-24 17:15:29
-->
<template>
...
import { exportPdf } from "../renderer/exportFile.js";
...
export default {
  ...
  mounted() {
    ...
    // 导出
    ipcRenderer.on("export", (e, data) => {
      if (data == "pdf") {
        console.log(
          this.$refs.mdr,
          document.querySelector(".v-show-content").scrollHeight
        );
        exportPdf('.v-show-content')
      } else {
        // exportTxt()
      }
    });
