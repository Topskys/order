...
<template>
    <header>
        ...
        <div class="user">
            <svg t="1678025743003" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <el-icon :size="20" color="#1d273b" style="margin:0 20px ;">
                <FullScreen/>
                <!--                <BottomLeft/>-->
            </el-icon>
            <el-icon :size="21" color="#1d273b" class="icon-bell">
                <Bell/>
                <!--                <sup class="bell-sup">·</sup>-->
            </el-icon>
            <div class="avatar">
                <div class="img"></div>
